...
public class CHIVWho : MonoBehaviour
{
    ...
    void Update()
    {
        if (Kit.KitchenShow >= 3 && CHIVQuestion1 == 0)
        {
            targetselfobject.GetComponent<Image>().enabled = true;
        }
        else if (CHIVQuestion1 == 1)
        {
            targetselfobject.SetActive(false);
        }
        if (CHIVWhere.CHIVQuestion2 == 1 || CHIVAlive.CHIVQuestion3 == 1)
        {
